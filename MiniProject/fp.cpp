...
void introScreen()
{
	...
	glColor3f(0, 0, 1);
	renderBitmapString(-150, 265, GLUT_BITMAP_TIMES_ROMAN_24, "DAYANANDA SAGAR ACADEMY");
	renderBitmapString(-160, 235, GLUT_BITMAP_TIMES_ROMAN_24, "TECHNOLOGY AND MANAGEMENT");
	glColor3f(0.7, 0, 1);
	renderBitmapString(-160, 190, GLUT_BITMAP_TIMES_ROMAN_24, "DEPARTMENT OF COMPUTER SCIENCE");
	/* renderBitmapString(-20, 205, GLUT_BITMAP_TIMES_ROMAN_24, "AND"); */
	/* renderBitmapString(-60, 180, GLUT_BITMAP_TIMES_ROMAN_24, "ENGINEERING"); */
	glColor3f(1, 0.5, 0);
	renderBitmapString(-90, 120, GLUT_BITMAP_TIMES_ROMAN_24, "A MINI PROJECT ON ~ SMASHi'N BALLS");
	glColor3f(1, 0, 0);
	/* renderBitmapString(-120, 90, GLUT_BITMAP_TIMES_ROMAN_24, "Ball Smasher"); */
	glColor3f(1, 0.5, 0);
	renderBitmapString(-290, -30, GLUT_BITMAP_TIMES_ROMAN_24, "BY:");
	glColor3f(0.5, 0, 0.5);
	renderBitmapString(-260, -60, GLUT_BITMAP_TIMES_ROMAN_24, "ARYAN      (1DT19CS023)");
	renderBitmapString(-260, -90, GLUT_BITMAP_TIMES_ROMAN_24, "AZEEM      (1DT19CS024)");
	glColor3f(1, 0.5, 0);
	/* renderBitmapString(40, -30, GLUT_BITMAP_TIMES_ROMAN_24, "GUIDES:"); */
	glColor3f(0.5, 0.2, 0.2);
	/* renderBitmapString(120, -60, GLUT_BITMAP_TIMES_ROMAN_24, "APOORVA BUSAD"); */
	/* renderBitmapString(120, -90, GLUT_BITMAP_TIMES_ROMAN_24, "SHALINI K"); */
	glColor3f(1, 0.1, 1);
	renderBitmapString(-80, -275, GLUT_BITMAP_TIMES_ROMAN_24, "Press Mouse-Click to Start");
